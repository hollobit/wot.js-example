...
var PERIPHERAL_ID = 'd03972c85adb'; //DCF31A460555 
...
async.series([
    ...
    function (done) {
        ...
        client.on('sensorData', function (data) {
            var requestOption = {
                url: 'http://192.168.88.9:8088/node/sensorData',
                method: 'post'
            };
            ...
            request(requestOption, function (error, response, body) {
                if (error || response.statusCode != 200) {
                    log.error('Send data to Edison(192.168.88.9) fail!');
                }
            });
    ...
    function (done) {
        ...
        var ds18b20 = 'sensorjs:///w1/28-28-000004f4b958/ds18b20/28-000004f4b958';
